...
public:
  ...
  Host::AllowedCapabilitiesMap& allowedCapabilities() { return allowed_capabilities_; }
  EnvironmentVariableMap& environmentVariables() { return envs_; }

private:
  const envoy::extensions::wasm::v3::PluginConfig config_;
  Host::AllowedCapabilitiesMap allowed_capabilities_{};
...
class Plugin : public Host::PluginBase {
public:
